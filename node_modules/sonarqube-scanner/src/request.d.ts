...
import { type ScannerProperties } from './types.js';
...
export declare function fetch<T = unknown>(config: AxiosRequestConfig): Promise<import("axios").AxiosResponse<T, any, {}, any>>;
